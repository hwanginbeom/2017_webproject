...
function ipinFindIdPopup( sMallId )
{
    ...
    var sipinFindIdForm = '<form id="ipinFindIdForm" method="post" action="https://i-pin.cafe24.com/ipin/ipin_auth_request.php" class="testClass">';
    sipinFindIdForm += '<input id="ipin_param1" name="ipin_param1" value="lost_id" type="hidden"  />';
    sipinFindIdForm += '<input id="ipin_param2" name="ipin_param2" value="" type="hidden"  />';
    sipinFindIdForm += '<input id="mallId" name="mallId" value="'+sMallId+'" type="hidden"  />';
    sipinFindIdForm += '<input id="returnType" name="returnType" value="^" type="hidden"  />';
    sipinFindIdForm += '<input id="version" name="version" value="shop19" type="hidden"  />';
    sipinFindIdForm += '<input id="ipin_returnUrl" name="ipin_returnUrl" value="' + EC_COMMON_UTIL.getProtocol() + '://' + document.domain + '/exec/front/Member/IpinResult/" type="hidden"  />';
...
function mobileAuthFindIdPopup( sMallId, AuthModule )
{
    ...
    sMobileForm += '<input id="param1" name="param1" value="lost_id" type="hidden"  />';
