    ...
    try {
        ...
        switch (type) {
            ...
            case "indibuis" :
                ...
                try{
                    search_type_ipin.style.display = 'inline';
                    search_type_ipin_lable.style.display = 'inline';
                }catch (e) {}

                try{
                    search_type_mobileauth.style.display = 'inline';
...
function ipinFindPwPopup( sMallId )
{
    ...
    var sipinFindPwForm = '<form id="ipinFindPwForm" method="post" action="https://i-pin.cafe24.com/ipin/ipin_auth_request.php" class="testClass">';
    sipinFindPwForm += '<input id="ipin_param1" name="ipin_param1" value="lost_pw" type="hidden"  />';
    sipinFindPwForm += '<input id="ipin_param2" name="ipin_param2" value="" type="hidden"  />';
    sipinFindPwForm += '<input id="mallId" name="mallId" value="'+sMallId+'" type="hidden"  />';
    sipinFindPwForm += '<input id="returnType" name="returnType" value="^" type="hidden"  />';
    sipinFindPwForm += '<input id="version" name="version" value="shop19" type="hidden"  />';
    sipinFindPwForm += '<input id="ipin_returnUrl" name="ipin_returnUrl" value="' + EC_COMMON_UTIL.getProtocol() + '://' + document.domain + '/exec/front/Member/IpinResult/" type="hidden"  />';
    sipinFindPwForm += '</form>';

    if ( $('#ipinFindPwForm').html() == null ) $('body').append(sipinFindPwForm);

    $('#ipinFindPwForm').attr('target', 'popupIpinfindpw');
    $('#ipin_param2').val( document.findPasswdForm.member_id.value );
...
function mobileAuthFindPwPopup( sMallId, AuthModule )
{
    ...
    sMobileForm += '<input id="param1" name="param1" value="lost_pw" type="hidden"  />';
